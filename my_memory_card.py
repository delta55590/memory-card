...
q = Question('Государственный язык Бразилии', 'Португальский', 'Английский', 'Испанский', 'Бразильский')
q1 = Question('Когда тает снег', 'Весной', 'Зимой', 'Летом', 'Осенью')
q2 = Question('Какая самая многонациональная страна в мире', 'Россия', 'Германия', 'Франция', 'Британия')
q3 = Question('Какой международный язык', 'Английский', 'Русский', 'Немецкий', 'Французский')
...
btn_OK.clicked.connect(check_answer) # по нажатии на кнопку выбираем, что конкретно происходит
ask(q)
